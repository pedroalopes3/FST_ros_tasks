...
(cl:defclass <coords_2d_array> (roslisp-msg-protocol:ros-message)
  ((points
    :reader points
    :initarg :points
    :type (cl:vector task2-msg:coords_2d)
   :initform (cl:make-array 0 :element-type 'task2-msg:coords_2d :initial-element (cl:make-instance 'task2-msg:coords_2d))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <coords_2d_array>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'coords_2d_array)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task2-msg:<coords_2d_array> is deprecated: use task2-msg:coords_2d_array instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <coords_2d_array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task2-msg:points-val is deprecated.  Use task2-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <coords_2d_array>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'task2-msg:coords_2d))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<coords_2d_array>)))
  ...
  (cl:format cl:nil "task2/coords_2d[] points~%================================================================================~%MSG: task2/coords_2d~%float32 x~%float32 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'coords_2d_array)))
  "Returns full string definition for message of type 'coords_2d_array"
  (cl:format cl:nil "task2/coords_2d[] points~%================================================================================~%MSG: task2/coords_2d~%float32 x~%float32 y~%~%~%"))
