...
#include "task3/coords_2d_array.h"
#include <sstream>
#include <iostream>
#include <vector>
#include <string>
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    ros::Publisher points_pub = nh.advertise<task3::coords_2d_array>("coords_2d_array", 1000);

    // Variable to store the points
    task3::coords_2d_array points;
